...
const tableStyle = css`
  /* Generated by http://tablestyler.com/ */
  .datagrid table {
  ...
  .datagrid table tfoot td div {
    border-top: 1px solid ${theme.colors.gray[8]};
    background: ${theme.colors.gray[1]};
  }
  ...
  .datagrid table tfoot li a {
    ...
    background: -webkit-gradient(
      ...
      left top,
      left bottom,
      color-stop(0.05, ${theme.colors.gray[6]}),
      color-stop(1, ${theme.colors.gray[8]})
    );
    background: -moz-linear-gradient(
      center top,
      ${theme.colors.gray[6]} 5%,
      ${theme.colors.gray[8]} 100%
    );
  ...
  .datagrid table tfoot ul a:hover {
    text-decoration: none;
    border-color: ${theme.colors.gray[7]};
    color: ${theme.colors.gray[1]};
    background: none;
    background-color: ${theme.colors.gray[6]};
  }
