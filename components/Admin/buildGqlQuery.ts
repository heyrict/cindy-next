...
export default (introspectionResults: IntrospectionResult) =>
  (
    ...
    const metaVariables = { filter: variables.filter };
      ...
      return gqlTypes.document([
        gqlTypes.operationDefinition(
          ...
          gqlTypes.selectionSet([
            ...
            gqlTypes.field(
              gqlTypes.name(`${singular(queryType.name)}Count`),
              gqlTypes.name('total'),
              metaArgs,
            ),
          ]),
  ...
  (fields: any): any =>
    fields.reduce(
      (
        ...
        if (linkedType && !paths.includes(linkedType.name as never)) {
          const possibleTypes =
          ...
          return [
            ...
            gqlTypes.field(
              ...
              null,
              gqlTypes.selectionSet([
                ...(buildFragments(introspectionResults)(possibleTypes) as any),
                ...buildFields(introspectionResults, [
                  ...paths,
                  linkedType.name,
                ] as any)((linkedType as IntrospectionObjectType).fields),
              ]),
            ),
          ];
        }
