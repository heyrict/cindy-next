...
import { PuzzleAddFormInnerProps, PuzzleAddFormVariables } from './types';
...
const PuzzleAddForm = () => {
  return (
    <Mutation mutation={AddPuzzleMutation}>
      {(addPuzzle: MutationFn) => (
        <Box px={[2, 3]} py={3}>
          <PuzzleAddFormInner
            onSubmit={(variables: PuzzleAddFormVariables) => {
              addPuzzle({
                variables,
              });
            }}
